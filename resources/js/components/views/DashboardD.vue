<template>
    ...
    <section class="py-3 py-md-5 py-xl-8 mt-5">
        ...
        <!-- Render chart only when data is loaded -->
        <div v-if="!loading && !secondLoading" class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <datatable
                        :key="'chart1-' + chartKey"
                        heading="Factors influencing your voting choice? (On a scale of 1 to 10, where 1 means least important and 10 means most important)."
                ...
                <div class="col-md-12">
                    <datatable
                        :key="'chart2-' + chartKey"
                        heading="Reasons for not voting or being unsure about voting ? (On a scale of 1 to 10, where 1 means a Weak Reason and 10 means a Strong Reason)."
        ...
        <div v-if="loading || secondLoading" class="text-center mt-3">
...
export default {
    ...
    data() {
        return {
            ...
            chartKey: 0, // Initialize key for chart component
